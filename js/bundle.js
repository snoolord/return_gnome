...
/***/ function(module, exports, __webpack_require__) {
	...
	$(function () {
	  var game = new _game2.default((0, _levels.levels)(), $('.forest'));
	});
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    value: function buttons() {
	      ...
	      var finishButton = $('.finish-level-button');
	      var that = this;
	      finishButton.on('click', function (e) {
	        e.preventDefault();
	        _this.currentLevel++;
	        _this.setupGame(_this.levels[_this.currentLevel]);
	        _this.disableButton();
	      });
	          ...
	          if ((0, _isEqual2.default)(answer, _this2.levels[_this2.currentLevel].solution)) {
	            if (win === 0) {
	              (function () {
	                ...
	                if (!completedLevels.includes(_this2.currentLevel)) {
	                  completedLevels.push(_this2.currentLevel);
	                }
	    ...
	    value: function setupGame(currentLevel) {
	      ...
	      $('.css-style').append('<textarea rows=\'' + (0, _keys2.default)(currentLevel.solution).length + ' cols=\'80\'></textarea>');
	      ...
	      var houseNumber = currentLevel.houses;
	      var houses = $('<div class="houses"></div>');
	      for (var i = 0; i < houseNumber; i++) {
	        var house = $('<img src="./imgs/house.png" class="house"></img>');
	        houses.append(house);
	      }
	      var houseStyling = currentLevel.solution;
	      houses.css('display', 'flex');
	      for (var key in houseStyling) {
	        houses.css(key, houseStyling[key]);
	      }
	      $('.game').append(houses);
	      var gnomes = currentLevel.gnomes;
	      for (var _i = 0; _i < gnomes.length; _i++) {
	        var gnome = $('<img src="./imgs/' + gnomes[_i] + '" class="gnome"></img>');
